...
| 질문 | 판정 | 핵심 수치 |
|---|---|---|
| 명령·조향 개재뉴런(AVB, AVA, SMDD, SMDV, RIV)만 자극해 화학주성이 되는가? | ✓ (3 시드 중 2) | 2.5 mm, 40초 안 도달률 0.914 (무작위 0.04). 시드 0/1/2: 0.914 / 0.973 / 0.301 (평균 0.73 ± 0.37); 셋째 시드는 후진 규칙은 배웠지만 깊은 굽힘을 쓰지 않았다 |
